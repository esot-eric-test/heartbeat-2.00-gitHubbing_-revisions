...
//This is only called by heart_update (internal use only)
static __inline__
uint8_t heartI_setLED(uint8_t ledVal)
   __attribute__((__always_inline__));


//Not that these names are particularly useful, but this is how they
//were...
...
#define heartPinSampleTime HEART_PULLUP_DELAY
   ...
   else
   {
                                                            ...
                                                            HEART_PRECISE))
      {
         ...
         setPinStatePORT(HEART_PINNUM, HEART_PINPORT, 
                                                   BUTTON_INPUT_PINSTATE);
 ...
 * /home/meh/_commonCode/heartbeat/2.00-gitHubbing_+revisions/testMega328P+button+DMS/_commonCode_localized/heartbeat/2.00-gitHubbing_+revisions/heartbeat.c
 *
