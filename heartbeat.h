...
//2.00-5-gitHubbing:
//       This is the first version of anything with gitHub...
//       The intention isn't to make heartbeat available to the public, but
//       to test whether there's a method for uploading a bunch of
//       commonCode to a single repository and update/download pieces as
//       necessary.
//       testMega328P is the actual repository,
//          it contains localized code from other commonThings
//
//  NOTE: This version has been stripped dramatically from its original
//        heartbeat, it doesn't include tools nor most tests.
//
//
//2.00-5 GO!
//       forgot Return False
 ...
 * /home/meh/_commonCode/heartbeat/2.00-gitHubbing_+revisions/testMega328P+button+DMS/_commonCode_localized/heartbeat/2.00-gitHubbing_+revisions/heartbeat.h
 *
